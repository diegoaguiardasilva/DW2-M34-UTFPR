                ...
                <ul class="bxslider">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slider-caption">
                                        ...
                                        <p class="color-white">Ter uma marca é ser lembrado, figuras ficam na memória</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="container caption-wrapper">
                            <div class="slider-caption">
                                <h2>Somos responsáveis</h2>
                                <p class="color-white">Cumprir prazos é um dos nossos pilares</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slider-caption">
                                        <h2>Transparência</h2>
                                        <p class="color-white">Faremos de tudo para que acompanhe a produção da sua marca!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slider-caption">
                                        <h2>Design & Inspiração</h2>
                                        <p class="color-white">A Arte nos move, apreciamos, sentimos! A sua marca terá a sua cara!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slider-caption">
                                        <h2>Amamos a Tecnologia</h2>
                                        <p class="color-white">Desenvolvemos uma plataforma completa para interagirmos</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
                        <div class="section-title">
                            ...
                            <hr>
                            <p>A criação de uma conta é gratuita. Seus dados ficarão seguros. Somos transparentes.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-offset-1 col-md-10 col-sm-12">
                        <form action="ClasseServlet" method="post" class="wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
                                <input type="submit" class="form-control" value="Nova Conta">
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="contact-detail col-md-12 col-sm-12">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <p>criart@gmail.com</p>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <h3><i class="icon-phone medium-icon wow bounceIn" data-wow-delay="0.6s"></i> PHONES</h3>
                            <p>+55 44 9 99693456</p>
                        </div>
                    </div>
